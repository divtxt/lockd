...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='locking',
  syntax='proto3',
  serialized_pb=_b('\n\rlocking.proto\x12\x07locking\"\x18\n\x08LockName\x12\x0c\n\x04name\x18\x01 \x01(\t\",\n\tLockState\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x11\n\tis_locked\x18\x02 \x01(\x08\"\x1d\n\nLockResult\x12\x0f\n\x07success\x18\x01 \x01(\x08\x32\xa4\x01\n\x07Locking\x12\x33\n\x08IsLocked\x12\x11.locking.LockName\x1a\x12.locking.LockState\"\x00\x12\x30\n\x04Lock\x12\x11.locking.LockName\x1a\x13.locking.LockResult\"\x00\x12\x32\n\x06Unlock\x12\x11.locking.LockName\x1a\x13.locking.LockResult\"\x00\x62\x06proto3')
)
...
_LOCKNAME = _descriptor.Descriptor(
  name='LockName',
  full_name='locking.LockName',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='locking.LockName.name', index=0,
...
_LOCKSTATE = _descriptor.Descriptor(
  name='LockState',
  full_name='locking.LockState',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='locking.LockState.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='is_locked', full_name='locking.LockState.is_locked', index=1,
...
_LOCKRESULT = _descriptor.Descriptor(
  name='LockResult',
  full_name='locking.LockResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='locking.LockResult.success', index=0,
...
LockName = _reflection.GeneratedProtocolMessageType('LockName', (_message.Message,), dict(
  ...
  __module__ = 'locking_pb2'
  # @@protoc_insertion_point(class_scope:locking.LockName)
  ))
...
LockState = _reflection.GeneratedProtocolMessageType('LockState', (_message.Message,), dict(
  ...
  __module__ = 'locking_pb2'
  # @@protoc_insertion_point(class_scope:locking.LockState)
  ))
...
LockResult = _reflection.GeneratedProtocolMessageType('LockResult', (_message.Message,), dict(
  ...
  __module__ = 'locking_pb2'
  # @@protoc_insertion_point(class_scope:locking.LockResult)
  ))
...
try:
  ...
  def beta_create_Locking_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ('locking.Locking', 'IsLocked'): LockName.FromString,
      ('locking.Locking', 'Lock'): LockName.FromString,
      ('locking.Locking', 'Unlock'): LockName.FromString,
    }
    response_serializers = {
      ('locking.Locking', 'IsLocked'): LockState.SerializeToString,
      ('locking.Locking', 'Lock'): LockResult.SerializeToString,
      ('locking.Locking', 'Unlock'): LockResult.SerializeToString,
    }
    method_implementations = {
      ('locking.Locking', 'IsLocked'): face_utilities.unary_unary_inline(servicer.IsLocked),
      ('locking.Locking', 'Lock'): face_utilities.unary_unary_inline(servicer.Lock),
      ('locking.Locking', 'Unlock'): face_utilities.unary_unary_inline(servicer.Unlock),
    }
  ...
  def beta_create_Locking_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('locking.Locking', 'IsLocked'): LockName.SerializeToString,
      ('locking.Locking', 'Lock'): LockName.SerializeToString,
      ('locking.Locking', 'Unlock'): LockName.SerializeToString,
    }
    response_deserializers = {
      ('locking.Locking', 'IsLocked'): LockState.FromString,
      ('locking.Locking', 'Lock'): LockResult.FromString,
      ('locking.Locking', 'Unlock'): LockResult.FromString,
    }
    cardinalities = {
    ...
    return beta_implementations.dynamic_stub(channel, 'locking.Locking', cardinalities, options=stub_options)
except ImportError:
  pass
