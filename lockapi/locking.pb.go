...
/*
Package locking is a generated protocol buffer package.
...
func init() {
	proto.RegisterType((*LockName)(nil), "locking.LockName")
	proto.RegisterType((*LockState)(nil), "locking.LockState")
	proto.RegisterType((*LockResult)(nil), "locking.LockResult")
}
...
func (c *lockingClient) IsLocked(ctx context.Context, in *LockName, opts ...grpc.CallOption) (*LockState, error) {
	out := new(LockState)
	err := grpc.Invoke(ctx, "/locking.Locking/IsLocked", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lockingClient) Lock(ctx context.Context, in *LockName, opts ...grpc.CallOption) (*LockResult, error) {
	out := new(LockResult)
	err := grpc.Invoke(ctx, "/locking.Locking/Lock", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lockingClient) Unlock(ctx context.Context, in *LockName, opts ...grpc.CallOption) (*LockResult, error) {
	out := new(LockResult)
	err := grpc.Invoke(ctx, "/locking.Locking/Unlock", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Locking_IsLocked_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/locking.Locking/IsLocked",
	}
...
func _Locking_Lock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/locking.Locking/Lock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Locking_Unlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/locking.Locking/Unlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func init() { proto.RegisterFile("locking.proto", fileDescriptor0) }

var fileDescriptor0 = []byte{
	// 197 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x09, 0x6e, 0x88, 0x02, 0xff, 0xe2, 0xe2, 0xcd, 0xc9, 0x4f, 0xce,
	0xce, 0xcc, 0x4b, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x87, 0x72, 0x95, 0xe4, 0xb8,
	...
	0x39, 0x39, 0xb5, 0xb8, 0x18, 0x6c, 0x02, 0x47, 0x10, 0x8c, 0x6b, 0xb4, 0x84, 0x91, 0x8b, 0xdd,
	0x07, 0xe2, 0x22, 0x21, 0x63, 0x2e, 0x0e, 0x4f, 0xa8, 0x7e, 0x21, 0x41, 0x3d, 0x98, 0xb3, 0x61,
	0x8e, 0x94, 0x12, 0x42, 0x11, 0x02, 0xbb, 0x4b, 0x89, 0x41, 0xc8, 0x80, 0x8b, 0x05, 0xc4, 0xc5,
	0xa6, 0x41, 0x18, 0x45, 0x08, 0xe2, 0x14, 0x25, 0x06, 0x21, 0x23, 0x2e, 0xb6, 0xd0, 0xbc, 0x1c,
	0x92, 0xf4, 0x24, 0xb1, 0x81, 0x03, 0xcf, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x41, 0xc9, 0xe7,
	0x09, 0x4d, 0x01, 0x00, 0x00,
}
